...
run_edgeR_zinbwavedata<-function(processed,cellinfo,cov=T,former.meth='zinbwave'){
  library(edgeR)
  ...
  save(res, cellinfo, file=paste0('./',ifelse(former.meth=='','',paste0(former.meth,'+')),'edgeR',ifelse(cov,'_Cov',''),'.rda'))
}